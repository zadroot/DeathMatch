...
LoadConVars()
{
	...
	AddConVar(ConVar_Pistols,        ValueType_Bool,   CreateConVar("dm_pistols",          "1",   "Give pistols for Rifleman & Support classes.",                     FCVAR_PLUGIN, true, 0.0, true, 1.0));
	...
	AddConVar(ConVar_SpawnSound,     ValueType_Bool,   CreateConVar("dm_spawnsound",       "1",   "Enable or disable respawn sound.",                                 FCVAR_PLUGIN, true, 0.0, true, 1.0));
}
